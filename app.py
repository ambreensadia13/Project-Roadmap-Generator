...
def build_prompt(
    ...
    if topic_choice == "Suggest a trending topic":
        ...
        topic_instruction = """
The user does not have a project topic yet.

Suggest 5 modern and currently relevant project ideas that match
the selected project type, experience level, skills, available time,
team size, and project goal.
...
Then select ONE project that fits the user's constraints.

Do not say that it is objectively the best project.
Explain why it fits this particular user's requirements.
"""
...
st.markdown(
    ...
    <div class="info-box">
        ...
        1. Choose the type of project you want to build.<br>

        2. Enter your experience and current skills.<br>

        3. Tell the AI how much time you have.<br>

        4. Enter your own idea or let AI suggest project ideas.<br>
...
if "roadmap" in st.session_state:
    ...
    st.write(
        """
        AI Study Planner • AI Legal Assistant •
        Cybersecurity Threat Analyzer • AI Email Generator •
        Smart Home IoT System • Student Complaint Management System
        """
    )
